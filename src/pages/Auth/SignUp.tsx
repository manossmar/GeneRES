                    ...
                    <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
                        ...
                        <div>
                            ...
                            <form onSubmit={handleSubmit}>
                                {error && (
                                    <div className="hidden bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4" role="alert">
                                        {error}
                                    </div>
                                )}
                                <div className="space-y-5">
                                    ...
                                    <div>
                                        <div>
                                            <label htmlFor="agreedToTerms" className="flex items-start text-sm font-normal text-gray-700 cursor-pointer select-none dark:text-gray-400">
                                                <div className="relative">
                                                    <input
                                                        type="checkbox"
                                                        id="agreedToTerms"
                                                        ...
                                                        className="sr-only"
                                                    />
                                                    <div className={`mr-3 flex h-5 w-5 items-center justify-center rounded-md border-[1.25px] ${agreedToTerms ? 'border-brand-500 bg-brand-500' : 'bg-transparent border-gray-300 dark:border-gray-700'}`}>
                                                        <span className={agreedToTerms ? '' : 'opacity-0'}>
